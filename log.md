...
2. [Set up release team](https://docs.ros.org/en/jazzy/How-To-Guides/Releasing/First-Time-Release.html)
...
3. Set up upstream and release super-repos
...
4. bloom-release pre-req: register to rosdistro

- [register jazzy](https://github.com/ros/rosdistro/pull/48401)

---

4. (configure local, bloom-release](https://robotics.stackexchange.com/a/117904/53773)

```
bloom-release --new-track --rosdistro jazzy --track jazzy ros2_eventdispatch
```

- [0.2.25](https://github.com/ros/rosdistro/pull/49010)
...
[openrobotics discourse](https://discourse.openrobotics.org/t/new-packages-for-jazzy-jalisco-2026-01-28/52166)
...
- [0.2.28](https://github.com/ros/rosdistro/pull/50526)
- [register humble, kilted, rolling](https://github.com/ros/rosdistro/pull/50757)
